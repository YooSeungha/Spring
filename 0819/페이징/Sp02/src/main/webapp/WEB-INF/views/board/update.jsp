...
<tr>
   ...
   <td>
      <input disabled name='writer' readonly value='${list.writer}'/>
   </td>
</tr>

<tr>
	<td align='center'>EMAIL</td>
	<td><input disabled name='email' readonly value="${list.email}"/></td>
</tr>

<tr>
	<td align='center'>SUBJECT</td>
	<td><input name='subject' value="${list.subject}"/></td>
</tr>
			
<tr>
	<td align='center'>CONTENT</td>
	<td><textarea id='ta' name='content' rows='15' cols='70'>${list.content}</textarea></td>
</tr>
</c:if>
</c:forEach>
<tr>
