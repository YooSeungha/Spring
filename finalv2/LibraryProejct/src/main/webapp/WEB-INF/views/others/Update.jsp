...
<body>
	...
	<main id="content">
        <div class="container" style="padding:50px">
        	...
        	<div class="container">
        <!-- ADD START -->
        <form id="frm" method="post" action="Update.do?seq=${board.seq}">
        ...
        <!-- ADD END -->
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="4" class="view_text">
                            <textarea title="내용" id="editor" name="content" style="width: 100%; height: 300px;">${board.content}</textarea>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <td colspan='2' align='center'>
				...
				<input type="button" value="취소" onclick="location.href='Bcontent?seq=${board.seq}'">
			</td>
        </form>
