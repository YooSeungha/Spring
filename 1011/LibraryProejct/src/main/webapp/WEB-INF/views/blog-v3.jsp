        ...
        <div class="mb-5 mb-lg-8 pb-xl-1">
                ...
                <div class="page-header border-bottom">
                    <div class="container">
                        <div class="d-md-flex justify-content-between align-items-center py-4">
                            <h1 class="page-title font-size-3 font-weight-medium m-0 text-lh-lg">도서관리 리스트</h1>
            ...
            <div class="container">
                <div class="row mb-lg-5 mb-xl-0">
                            ...
                            <div id="Tags" class="widget p-4 border">
                                ...
                                <div id="Collapse24" class="mt-3 collapse"
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        href="../shop/v1.html">Books</a>

                                        <a class="btn d-flex align-items-center justify-content-center bg-gray-200 rounded-0 transition-3d-hover font-size-2 mr-2 mb-2 height-38 width-80"
                                        href="../shop/v1.html">read</a>
                                        ...
                                        href="../shop/v1.html">Education & Teaching</a>
                                        ...
                                        href="../shop/v1.html">Love</a>

                                        <a class="btn d-flex align-items-center justify-content-center bg-gray-200 rounded-0 transition-3d-hover font-size-2 mr-2 mb-2 height-38 width-70"
                                        href="../shop/v1.html">Advice</a>
                    ...
                    <c:forEach items="${listResult.bookListResult.bookList}" var="book">
                        <div class="d-md-flex align-items-center mb-5">
                            <span class="d-block mb-3 mb-md-0">
                                <img class="img-fluid" src="${book.book_img}" alt="Image-Description" width=150px; height=150px;>
                            </span>
                            <div class="ml-md-8">
                                <div class="mb-2">
                                    <span class="font-size-2">${book.book_publisher}</span>
                                </div>
                                <h6 class="font-size-7 crop-text-2 font-weight-medium text-lh-1dot4">
                                    <span>${book.book_title}</span>
                                </h6>
                                <p class="font-size-2 text-secondary-gray-700">${book.book_writer}</p>
                                <div class="font-size-2 text-secondary-gray-700">
                                    <span>ISBN : ${book.book_isbn}</span>
                                    <span class="ml-3">도서수량 : ${book.book_count}권</span>
                                    <span class="ml-3">도서위치 : ${listResult.facilityList[book.f_num-1]}</span>                                    
                                </div>                                
                            </div>
                            <a class="btn btn-primary btn-sm-wide transition-3d-hover" href="/admin/book/update?book_num=${book.book_num}">수정</a>
                            &nbsp;
                            <a class="btn btn-primary-red btn-sm-wide transition-3d-hover" href="/admin/book/del">삭제</a>
                        </div>  
                        <hr>
                      </c:forEach>             
                    </div>
