                                ...
                                <form name="update" method="post" class="checkout woocommerce-checkout row mt-8" action="update.do" novalidate="novalidate" style="text-align:center;">
                                    <div class="col2-set col-md-6 col-lg-7 col-xl-8 mb-6 mb-md-0" id="customer_details" style="margin-right:auto; margin-left:auto;">
                                            ...
                                            <div class="woocommerce-billing-fields">
                                                ...
                                                <div class="woocommerce-billing-fields__field-wrapper row">
                                                    <p class="col-lg-6 mb-4d75 form-row form-row-first validate-required woocommerce-invalid woocommerce-invalid-required-field" id="billing_first_name_field" data-priority="10">
                                                        ...
                                                        <input type="text" class="input-text form-control" name="book_title" id="book_title" placeholder="도서 제목을 입력해주세요" value="${listResult.libraryBook.book_title}" autocomplete="given-name" autofocus="autofocus">
                                                    </p>
                                                    ...
                                                    <p class="col-lg-6 mb-4d75 form-row form-row-last validate-required" id="billing_last_name_field" data-priority="20">
                                                        ...
                                                        <input type="text" class="input-text form-control" name="book_writer" id="book_writer" placeholder="도서 저자를 입력해주세요" value="${listResult.libraryBook.book_writer}" autocomplete="family-name">
                                                    </p>
                                                    ...
                                                    <p class="col-12 mb-4d75 form-row form-row-wide" id="billing_company_field" data-priority="30">
                                                        ...
                                                        <input type="text" class="input-text form-control" name="book_publisher" id="book_publisher" placeholder="도서 출판사를 입력해주세요" value="${listResult.libraryBook.book_publisher}" autocomplete="organization">
                                                    </p>
                                                    ...
                                                    <p class="col-12 mb-4d75 form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated" id="billing_country_field" data-priority="40">
                                                        <label for="billing_country" class="form-label">도서 추천<abbr class="required" title="required"></abbr></label>
                                                        <select name="book_recomend" id="book_recomend" class="form-control country_to_state country_select  select2-hidden-accessible"
                                                            autocomplete="country" tabindex="-1" aria-hidden="true">
                                                            <option value="">도서 추천 선택</option>                                                            
                                                    ...
                                                    <p class="col-12 mb-3 form-row form-row-wide address-field validate-required" id="billing_address_1_field" data-priority="50">
                                                        ...
                                                        <input type="text" class="input-text form-control" name="book_isbn" id="book_isbn" placeholder="도서 ISBN번호를 입력해주세요" value="${listResult.libraryBook.book_isbn}" autocomplete="address-line1">
                                                    </p>
                                                    ...
                                                    <p class="col-12 mb-4d75 form-row form-row-wide address-field validate-required" id="billing_city_field" data-priority="70" data-o_class="form-row form-row-wide address-field validate-required">
                                                        <label for="billing_city" class="form-label">도서 수량<abbr class="required" title="required"></abbr></label>
                                                        <input type="number" class="input-text form-control" name="book_count" id="book_count" placeholder="" value="${listResult.libraryBook.book_count}" autocomplete="address-level2">
                                                    </p>   
                                        ...
                                        <div class="form-row place-order">
                                            ...
                                            <input type="hidden" id="book_code" name="book_code" value="${listResult.libraryBook.book_code}">
                                        </div>
                                    </div>                                    
                                </form>
                                <script>
				                	...
				                	jQuery(function($) {
										$("#book_title").keydown(function(e) {		// 메인 페이지 중간 검색어 입력박스 엔터-키 처리
											if (e.keyCode == 13) {
												$("#update_btn").trigger( "click" );
											}
										});
										$("#book_writer").keydown(function(e) {		// 메인 페이지 중간 검색어 입력박스 엔터-키 처리
											if (e.keyCode == 13) {
												$("#update_btn").trigger( "click" );
											}
										});
										$("#book_publisher").keydown(function(e) {		// 메인 페이지 중간 검색어 입력박스 엔터-키 처리
											if (e.keyCode == 13) {
												$("#update_btn").trigger( "click" );
											}
										});
										$("#book_isbn").keydown(function(e) {		// 메인 페이지 중간 검색어 입력박스 엔터-키 처리
											if (e.keyCode == 13) {
												$("#update_btn").trigger( "click" );
											}
										});
										$("#book_count").keydown(function(e) {		// 메인 페이지 중간 검색어 입력박스 엔터-키 처리
											if (e.keyCode == 13) {
												$("#update_btn").trigger( "click" );
											}
										});
										$("#book_img").keydown(function(e) {		// 메인 페이지 중간 검색어 입력박스 엔터-키 처리
											if (e.keyCode == 13) {
												$("#update_btn").trigger( "click" );
											}
										});
