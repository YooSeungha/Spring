        		...
        		<div class="col-md-12">
        			<h3>알림</h3>
					  <ol class="breadcrumb" style="background-color:white">
					    ...
					    <li class="breadcrumb-item"><a href="Board">공지사항</a></li>
        		...
        		<h3>작성</h3>
	        		<form name="tform" action="edit.do" method="post" enctype="multipart/form-data" onsubmit="return fcheck();">
	        		 <table>
	        		 	<tr>
            				<td>제목</td>
            				<td><input type="text" name="pb_title" style="width: 100%"></td>
        				</tr>
        				<tr>
            				<td>작성자</td>
            				<td>
            					<input type="text" name="mem_num" readonly value="${member.mem_num}" style="background: #CCCCCC;">
            					<input type="hidden" name="mem_num" readonly value="${member.mem_num}"/>
            				</td>
        				</tr>
        				...
        				<tr>
            				<td>내용</td>
            				<td>
                			<textarea name="pb_content" id="editor"></textarea>
            				</td>
        				</tr>
        				<tr>
						...
						<tr>
							<td>상단고정</td><td align="left">
							<input type="checkbox" name="pb_top" id="check" value="1"/>&nbsp; 상단고정</td>
						</tr>
    				</table>
	   						<p style="float: right">
