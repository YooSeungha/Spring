	...
	<script>
		$(function(){
		 	$("#resetBtn").on("click", function(){
		 		location.href="Board?cp=1&searchModeStr=F";
		 	});
		});
	</script>	
	...
	<main id="content">
        ...
        <div class="row" style="justify-content: right;">
        	...
        	<div class="row" style="padding:5px">
			 <div class="col-md-10">전체<span> ${listResult.totalCount}</span>/ 검색 <span> ${listResult.totalCount}</span></div>
        		...
        		<table class="table" style="text-align: center;">
        			...
        			<c:forEach items="${listResult.list}" var="board">
        				<tr>
	        				<td>${board.pb_num}</td>
	        				<td>
	        				<a href="Bcontent?pb_num=${board.pb_num}">${board.pb_title}</a>
	        				</td>
	        				<td>${board.mem_num}</td>
			...
			<div class="container"style="padding:5px; text-align: center;">
        		<form action="write" id="t_1" method="GET">
