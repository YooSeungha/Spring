        ...
        <!-- ADD END -->
            <table class="board_detail">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row">제목</th>
                        <td><input type="text" id="title" name="pb_title" style="width:100%" value="${board.pb_title}"/></td>
                        <th scope="row">파일</th>
            ...
            <td colspan='2' align='center'>
				...
				<input type="button" value="취소" onclick="location.href='Bcontent?pb_num=${board.pb_num}'">
			</td>
        </form>
