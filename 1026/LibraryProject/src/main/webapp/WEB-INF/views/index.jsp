                ...
                <div class="col mb-5 mb-xl-0">
                    <div class="text-center">
                        <a href="/library/category/book?catgoId=0&page=1&show=12">
                            ...
                            <span class="tabtext font-size-3 font-weight-medium text-dark">소장도서</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="col mb-5 mb-xl-0">
                    <div class="text-center">
                        <a href="library/category/dvd?page=1&show=12">
                            ...
                            <span class="tabtext font-size-3 font-weight-medium text-dark">DVD</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="col mb-5 mb-xl-0">
                    <div class="text-center">
                        <a href="#" onclick="rezSave();">
                            ...
                            <span class="tabtext font-size-3 font-weight-medium text-dark">열람실 예약</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="col mb-5 mb-xl-0">
                    <div class="text-center">
                        <a href="/others/PBoard">
                            ...
                            <span class="tabtext font-size-3 font-weight-medium text-dark">공지사항</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="col mb-5 mb-xl-0">
                    <div class="text-center">
                        <a href="/others/read.do">
                            ...
                            <span class="tabtext font-size-3 font-weight-medium text-dark">게시판</span>
                        </a>
                    </div>
                </div>
