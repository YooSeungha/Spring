...
<body>
    ...
    <main id="content">
		<div class="py-1 py-lg-7" style="position: relative;">
             ...
             <br><br><br>
          <div style="color:white; left: 40%; width: 20%; bottom: 220px; font-size: 1.7em; font-weight: bold;   position: absolute">게시글 상세보기</div></h6>
        </div>
        <div id="mainWrapper">
			...
			<article>		
				<div class="container" role="main">
					...
					<input type="hidden" name="b_num" value="${bo.b_num}">
						...
						<hr width = "100%" color = "green" size = "3">
						<div class="mb-3">
   ...
   <div id="reviewWrapper">
                   <!-- Nav Classic -->					
                        <hr width = "100%" color = "green" size = "5">   
                        <h4 > 댓글(<b style="color:#f75454 ;"> ${count} </b>)
