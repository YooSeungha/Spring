...
<body>
    ...
    <main id="content">
		<div class="py-1 py-lg-7" style="position: relative;">
             ...
             <br><br><br>
          <div style="color:white; left: 40%; width: 20%; bottom: 220px; font-size: 1.8em; font-weight: bold;   position: absolute"> 글쓰기</div></h6>
        </div>
			...
			<article>		
				<div class="container" role="main">
					...
					<form name="forms" id="forms" role="forms" method="post" action="/others/write.do">	
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" name="name" id="name" readonly value="${member.mem_name}"/>
							<input type="hidden" class="form-control" name="mem_num" id="mem_num" readonly value="${member.mem_num}"/>
						</div>
						<div class="mb-3">
						<label for="content">내용</label>	
						<textarea class="form-control" rows="5" name="b_content" id="b_content" placeholder="내용을 입력해 주세요" ></textarea>	
						</div>	
						
						
					</form>	
					
					<button type="button"  class="btn btn-primary btn-sm-wide transition-3d-hover" id="btnSave">저장</button>
   ...
   <!-- jQuery first, then Popper.js, then Bootstrap JS -->
    ...
    $(document).ready(function (e){
      	$('#btnSave').on("click", function(){
      			 ...
      			 if($("#b_content").val() != "" && $("#b_title").val() != ""){
      				$('#forms').submit();
      				
      			}else{
      				alert("제목 또는 내용을 적어야 됩니다")
      			} 
      		});
  	});
