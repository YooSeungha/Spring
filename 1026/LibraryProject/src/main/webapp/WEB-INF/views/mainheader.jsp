        ...
        <div class="masthead">
            <div class="container pt-3 pt-md-4 pb-3 pb-md-5">
                <div class="d-flex align-items-center position-relative flex-wrap">
                    <c:choose>
                    	<c:when test="${member.mem_grade<2 }"><!-- 관리자 페이지 -->
                        ...
                        <form action="/search/book" class="form-inline my-2 my-xl-0">
                            <div class="input-group input-group-borderless w-100">
                                <div class="input-group-prepend border-right mr-0 d-none d-xl-block">
                                    <select id="selected_type" class="custom-select pr-7 pl-4 rounded-right-0 height-5 shadow-none border-0 text-dark bg-gray-200" id="inputGroupSelect01" style="font-family: 'SUIT-Medium';">
                    ...
                    <div class="d-flex align-items-center mt-lg-3 mt-xl-0">                                           
                        ...
                        <a id="sidebarNavToggler" href="naverlogin.do" onclick="loginNaver()" role="button"
                            ...
                            <div class="d-flex align-items-center text-white font-size-2 text-lh-sm">
                              	<i class="fa-regular fa-user" style="color:#0e306c;font-size:25px;"></i>
                                <div class="ml-2 d-none d-lg-block">
                                    <span class="text-secondary-gray-1080 font-size-1" ></span>
                                </div>
                            </div>
                        </a>
                        <!-- Cart Sidebar Toggle Button -->
		                        <a id="sidebarNavToggler1" href="javascript:;" role="button" class="ml-4 d-none d-lg-block"
		                            ...
		                            <div class="d-flex align-items-center text-white font-size-2 text-lh-sm position-relative">
		                                ...
		                                <i class="fa-solid fa-gear" style="color:#0e306c;font-size:25px;"></i>
		                                <div class="ml-2">
                        ...
                        <!-- End Account Sidebar Toggle Button -->
	                             ...
	                             <a id="sidebarNavToggler" href="" role="button"
			                            ...
			                            <div class="d-flex align-items-center text-white font-size-2 text-lh-sm">
			                                <i class="fa-regular fa-user" style="color:#0e306c;font-size:25px;"></i>
		                                <div class="ml-2 d-none d-lg-block">
			                             	<span class="text-secondary-gray-1080 font-size-1">${member.mem_name} 님</span>
			                             </div>
		                            </div>
		                        </a>
		                        <!-- Cart Sidebar Toggle Button -->
		                        <a id="sidebarNavToggler1" href="javascript:;" role="button" class="ml-4 d-none d-lg-block"
		                            ...
		                            data-unfold-duration="500">
		                            <div class="d-flex align-items-center text-white font-size-2 text-lh-sm position-relative">
		                                <!-- <span class="position-absolute width-16 height-16 rounded-circle d-flex align-items-center justify-content-center bg-dark-1 text-white font-size-n9 left-0 top-0 ml-n2 mt-n1">호수빈</span> -->
		                                <i class="fa-sharp fa-solid fa-heart" style="color:#0e306c;font-size:25px;"></i>
		                                <div class="ml-2">
		                                    <!-- <div class="font-size-2 text-secondary-black-100">돈 표시</div> -->
		                                </div>
		                            </div>
            ...
            <div class="container">
                <div class="bg-primary rounded-md d-none d-md-block">
                    <div class="d-flex align-items-center justify-content-center position-relative" style="font-family: 'SUIT-Medium';">
                            ...
                            <ul class="nav pl-xl-4">
                                ...
                                <li class="nav-item dropdown">
                                    <a id="blogDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-3 px-0 py-3 font-size-2 font-weight-medium d-flex align-items-center"
                                        ...
                                        data-unfold-animation-in="slideInUp"
                                        data-unfold-animation-out="fadeOut">
                                      	소장도서&nbsp;<i class="fa-solid fa-chevron-down"></i>
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a href="http://localhost:3000" class="nav-link link-black-100 mx-3 px-0 py-3 font-size-2 font-weight-medium d-flex align-items-center">
                                        독서 클럽&nbsp;<i class="fa-solid fa-book-open-reader"></i>
                                    </a>
                                </li>
                            ...
                            <form class="" action="/login.do" method="post">
                                ...
                                <div id="login" data-target-group="idForm">
                                    ...
                                    <div class="p-4 p-md-6">
                                        ...
                                        <div class="d-flex justify-content-between mb-5 align-items-center">
                                            ...
                                            style="text-decoration: none;"><span class="material-icons" style="vertical-align: -6px; font-size:22px;" >person_search</span>계정 찾기</a>
                                            
                                            <a class="js-animation-link text-dark font-size-2 t-d-u link-muted font-weight-medium" href="javascript:;"
                                            data-target="#forgotPassword"
                                            data-link-group="idForm"
                                            data-animation-in="fadeIn"
                                            style="text-decoration: none;"><i class="fa-solid fa-magnifying-glass-arrow-right"></i>비밀번호 찾기</a>
                                ...
                                <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                                    ...
                                    <div class="p-4 p-md-6">
								        ...
								        <c:if test="${doubleLogin == true}">
								          	<script>
								          		alert("※ Login - Fail ※\다른 브라우져에서 이용중입니다.");
								          	</script>
								        </c:if>
            ...
            <div class="u-sidebar__container">
                <div class="u-header-sidebar__footer-offset">
                                    ...
                                    <div class="p-4 p-md-6">
                                        ...
                                        <!-- 신청도서 이력 버튼 -->
                                         <div class="mb-2">
											...
											data-link-group="idForm"
											data-animation-in="fadeIn"><span style="font-size:18px;" class="material-icons">bookmark_add 신청도서이력</span></a>
										</div>
                                        <!-- 신청도서 이력 버튼 끝 -->
                    ...
                    <!-- 대출이력 화면 -->
							...
							<!-- 신청도서이력  화면 -->
	                              <div id="myrequest" style="display: none; opacity: 0;" data-target-group="idForm">
										<!-- Title -->
										<header class="border-bottom px-4 px-md-6 py-4">
											<h2 class="font-size-3 mb-0 d-flex align-items-center"><span style="font-size:18px;" class="material-icons">bookmark_add</span>신청도서 이력</h2>
										</header>
										<!-- End Title -->
										...
										<tbody>
										<c:forEach items="${mem_request}" var="list">
											<tr>
												<td>${list.br_title}</td>
												...
												<c:choose>
													<c:when test="${list.br_stat==0}">
														<td><span style="color:red;">신청대기중</span></td>	
													</c:when>
													<c:when test="${list.br_stat==1}">
														<td><span style="color:green;">신청승인</span></td>	
													</c:when>													
												</c:choose>	
											</tr>
											</c:forEach>
...
<!-- 마이페이지 끝 -->
                            ...
                            <div class="border-bottom">
                                <div class="zeynep pt-4">
                                    <ul>
                                        ...
                                        <li class="has-submenu">
                                            <a href="/admin/dvd/search" data-submenu="biography">DVD관리</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <!-- 일반 회원 왼쪽 사이드 바  -->
     <!-- 메인 왼쪽 사이드바 -->
    <aside id="sidebarContent3" class="u-sidebar u-sidebar__md u-sidebar--left" aria-labelledby="sidebarNavToggler3">
        <div class="u-sidebar__scroller js-scrollbar">
            <div class="u-sidebar__container">
                <div class="u-header-sidebar__footer-offset">
                    <!-- Content -->
    ...
    <script>
        $(document).on('ready', function () {
            ...
            $(".cat-menu").click(function () {
            	console.log($("html").hasClass("zeynep-opened"));
