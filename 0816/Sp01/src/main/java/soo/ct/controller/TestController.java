...
public class TestController {
	...
	public void m06(Human dto) {
		//log.info("m05()- name :" + dto.getName() +" , age: "+ dto.getAge());
		log.info("#m06()- " + dto);
	}
	...
	public void m11(Human dto, @RequestParam("dump") String cla, int grade ) {
		//log.info("m05()- name :" + dto.getName() +" , age: "+ dto.getAge());
		log.info("#m10()- " + dto +", cla: "+ cla +", grade:"+ grade);
	}
